...
const (
	...
	StorageProfilePhaseInit   StorageProfilePhase = "Initializing"
	StorageProfilePhaseReady  StorageProfilePhase = "Ready"
)

// StorageProfileMessage stores a StorageProfile reconciliation message
type StorageProfileMessage string

const (
	StorageProfilePhaseReadyMessage StorageProfileMessage = "StorageProfile reconcile completed successfully"
	StorageProfileNotFound          StorageProfileMessage = "no storage profile definition found for storage profile"
	StorageProfileListError         StorageProfileMessage = "Unable to list StorageProfile objects"
)
